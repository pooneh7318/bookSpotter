function addToBasket(opt,ajaxNeeded) {
	console.log("lets add in");

  if(ajaxNeeded) {
	  console.log("lets ajax");
    $.ajax({
      url: 'http://localhost/bookspotter/public/addBasket',
      type: "get",
      data: opt,
...
function removeFromBasket(target) {
  ...
  $.ajax({
    url: 'http://localhost/bookspotter/public/removeBasket',
    type: "get",
    data: {'id':pid},
    success: function(data){
      alert("data="+data);
...
function getBasket() {
  var basket;
  $.ajax({
    url: 'http://localhost/bookspotter/public/getBasket',
    type: "get",
    dataType: 'json',
    success: function (data) {
